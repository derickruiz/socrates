...
(function(root, factory) {
    ...
    Timer.prototype.start = function(duration) {
        ...
        if (typeof this._.options.ontick === 'function') this._.interval = setInterval(function() {
    ...
    Timer.prototype.getDuration = function() {
        if (this._.status === 'started') return this._.duration - (+new Date - this._.start)
    ...
    Timer.prototype.options = function(option, value) {
        ...
        if (!value && typeof option === 'object') for (var prop in option)
    ...
    Timer.prototype.on = function(option, value) {
        ...
        if (this._.options.hasOwnProperty(option)) this._.options[option] = value
        return this
    }
    ...
    Timer.prototype.off = function(option) {
        ...
        if (!(/^on/).test(option)) option = 'on' + option
        if (this._.options.hasOwnProperty(option)) this._.options[option] = defaultOptions[option]
        return this
    }
